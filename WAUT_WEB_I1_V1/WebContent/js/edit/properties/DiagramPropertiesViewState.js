DiagramPropertiesViewState = Class
		.extend({
			NAME : "DiagramPropertiesViewState",
			...
			getPropertyView : function() {
				...
				var view = $('<div id="diagramPropertiesState-container" class="row"></div>');
				...
				// action 추가 부분
				var actionFromGroup = diaPropViewItems.getActionFromGroup();

				
				view.append(nameFromGroup);
				view.append(stereoTypeFromGroup);
				view.append(actionFromGroup);
