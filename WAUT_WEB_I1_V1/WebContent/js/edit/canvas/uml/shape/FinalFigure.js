FinalFigure = draw2d.shape.basic.Circle.extend({

	NAME : "FinalFigure",

	init : function(attr, setter, getter) {
		this.innerCircle = new draw2d.shape.basic.Circle({
			radius : 10,
			stroke : 2,
			bgColor : "#000000",
			color : "#000000"
	...
	setDimension : function(w, h) {
		this._super(w, h);
		this.innerCircle.setDimension(this.getWidth() - 15, this.getHeight() - 15);
	},
	/**
