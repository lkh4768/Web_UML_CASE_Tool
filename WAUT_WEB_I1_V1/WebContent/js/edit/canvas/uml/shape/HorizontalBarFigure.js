HorizontalBarFigure = draw2d.shape.basic.Rectangle.extend({

	NAME : "HorizontalBarFigure",
	init : function(attr, setter, getter) {
		// horizontal bar figure 색, 도형 크기 설정
		this._super($.extend({
			width : 1,
			height : 150,
			bgColor : "#000000"
	...
	// horizontal bar figure는 항상 너비가 1이여야 하기 때문에 크기변경시 w는 항상 1
