PackageFigure = draw2d.shape.layout.FlexGridLayout.extend({
	...
	init : function(attr, setter, getter) {
		...
		this.nameLabel.add(this.stereoTypeLabel, new draw2d.layout.locator.TopLocator(-10, -10));
	},
