ActorFigure = draw2d.SetFigure.extend({
	NAME : "ActorFigure",

	/**
	 * 
	 * @constructor Creates a new icon element which are not assigned to any
	 *              canvas.
	 * 
	 * @param {Object}
	...
	init : function(attr, setter, getter) {
		...
		this.add(this.nameLabel, new draw2d.layout.locator.BottomLocator());
	...
	createSet : function() {
		...
		shape = this.canvas.paper.circle(16, 8, 9);
		shape.attr({
			'fill' : 'none',
			'stroke' : '#010102',
			'stroke-width' : '2',
		...
		shape = this.canvas.paper.path('M 16,18 L 16,40');
		shape.attr({
			'fill' : 'none',
			'stroke' : '#010102',
			'stroke-width' : '2',
		...
		shape = this.canvas.paper.path('M 0,26 L 32,26');
		shape.attr({
			'fill' : 'none',
			'stroke' : '#010102',
			'stroke-width' : '2',
		...
		shape = this.canvas.paper.path('M 16,40 L 0,50');
		shape.attr({
			'fill' : 'none',
			'stroke' : '#010102',
			'stroke-width' : '2',
		...
		shape = this.canvas.paper.path('M 16,40 L 32,50');
		shape.attr({
			'fill' : 'none',
			'stroke' : '#010102',
			'stroke-width' : '2',
